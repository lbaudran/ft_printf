...
/*   Updated: 2016/05/02 16:25:41 by lbaudran         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char			*putline_str(char *line, t_list *elem,
				int *tab, const char *fmt);
char			*print_arg(int *tab, va_list *arg,
				t_list *elem, const char *fmt);
void			init_pt_tab(char *(**types)
				(va_list *arg, char *buffer, int *tab, t_list *elem));
char			*check_percent(va_list *arg, char *buffer,
				int *tab, t_list *elem);
char			*get_int(va_list *arg, char *buffer,
				int *tab, t_list *elem);
char			*get_char(va_list *arg, char *buffer,
				int *tab, t_list *elem);
char			*get_nothing(va_list *arg, char *buffer,
				int *tab, t_list *elem);
char			*get_str(va_list *arg, char *buffer,
				int *tab, t_list *elem);
char			*get_int_ns(va_list *arg, char *buffer,
				int *tab, t_list *elem);
char			*get_octal(va_list *arg, char *buffer,
				int *tab, t_list *elem);
char			*get_hexa_low(va_list *arg, char *buffer,
				int *tab, t_list *elem);
char			*get_hexa_up(va_list *arg, char *buffer,
				int *tab, t_list *elem);
char			*get_double(va_list *arg, char *buffer,
				int *tab, t_list *elem);
char			*get_scient(va_list *arg, char *buffer,
				int *tab, t_list *elem);
char			*get_scient_up(va_list *arg, char *buffer,
				int *tab, t_list *elem);
char			*get_shorter(va_list *arg, char *buffer,
				int *tab, t_list *elem);
char			*get_shorter_up(va_list *arg, char *buffer,
				int *tab, t_list *elem);
char			*get_wstring(va_list *arg, char *buffer,
				int *tab, t_list *elem);
...
void			init_diez_tab(char *(**diez)(char *tmp,
				char *buffer, int *tab));
...
char			*get_long_long_unsigned(va_list *arg, char *buffer, int *tab,
				int base);
char			*get_long_unsigned(va_list *arg,
				char *buffer, int *tab, int base);
char			*get_short_unsigned(va_list *arg,
				char *buf, int *tab, int base);
char			*get_normal_unsigned(va_list *arg,
				char *buffer, int *tab,
				int base);
char			*get_short_short_unsigned(va_list *arg, char *buffer, int *tab,
				int base);
char			*get_size_unsigned(va_list *arg,
				char *buffer, int *tab, int base);
char			*get_unsigned_max(va_list *arg, char
				*buffer, int *tab, int base);
